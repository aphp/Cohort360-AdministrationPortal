...
import TransfertsDatalabTable from 'components/Jupyter/TransfertsTable/TransfertsDatalabTable'

import { getUserRights, userDefaultRoles } from 'utils/userRoles'

import useStyles from './styles'

const TransfertDatalab: React.FC = () => {
      ...
      <Grid container justifyContent="center">
        <Grid container item xs={12} md={10}>
          ...
          {loading ? (
            ...
            <TransfertsDatalabTable userRights={userRights} />
          )}
        </Grid>
      </Grid>
    </Grid>
...
export default TransfertDatalab
